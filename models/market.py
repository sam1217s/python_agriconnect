...
def train_market_baseline():
    """
    Entrena el modelo baseline de predicción de precios de mercado
    """
    ...
    # Retornar modelo y métrica (consistente con climate.py)
    return {"model": model, "mae": mae}

# Si quieres que se ejecute directamente al importar (opcional)
